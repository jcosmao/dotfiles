...
function M.setColorscheme()
    ...
    if vim.o.background == 'light' then
        ...
        -- Render Markdown highlight groups (Gruvbox Light)
        vim.api.nvim_set_hl(0, 'RenderMarkdownH1', { fg = colors.blue, bg = colors.bg4, bold = true })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH2', { fg = colors.green, bg = colors.bg4, bold = true })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH3', { fg = colors.purple, bg = colors.bg4, bold = true })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH4', { fg = colors.orange, bg = colors.bg4 })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH5', { fg = colors.yellow, bg = colors.bg4 })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH6', { fg = colors.aqua, bg = colors.bg4 })
        vim.api.nvim_set_hl(0, 'RenderMarkdownCode', { bg = colors.bg1 })
        vim.api.nvim_set_hl(0, 'RenderMarkdownCodeBorder', { fg = colors.grey, bg = colors.bg1 })
        ...
        -- Render Markdown highlight groups (Catppuccin dark)
        vim.api.nvim_set_hl(0, 'RenderMarkdownH1', { fg = colors.blue, bg = colors.crust, bold = true })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH2', { fg = colors.green, bg = colors.crust, bold = true })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH3', { fg = colors.mauve, bg = colors.crust, bold = true })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH4', { fg = colors.yellow, bg = colors.crust })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH5', { fg = colors.peach, bg = colors.crust })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH6', { fg = colors.teal, bg = colors.crust })
        vim.api.nvim_set_hl(0, 'RenderMarkdownCode', { bg = colors.mantle })
        vim.api.nvim_set_hl(0, 'RenderMarkdownCodeBorder', { fg = colors.surface2, bg = colors.mantle })
        vim.api.nvim_set_hl(0, 'RenderMarkdownLink', { fg = colors.sky, underline = true })
    end

...
function M.setColorscheme()
    ...
    if vim.o.background == 'light' then
        ...
        vim.api.nvim_set_hl(0, 'RenderMarkdownH2', { fg = colors.green, bg = colors.bg3, bold = true })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH3', { fg = colors.purple, bg = colors.bg2, bold = true })
        ...
        vim.api.nvim_set_hl(0, 'RenderMarkdownH1', { fg = colors.blue, bg = colors.mantle, bold = true })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH2', { fg = colors.green, bg = colors.mantle, bold = true })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH3', { fg = colors.mauve, bg = colors.mantle, bold = true })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH4', { fg = colors.yellow, bg = colors.mantle })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH5', { fg = colors.peach, bg = colors.mantle })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH6', { fg = colors.teal, bg = colors.mantle })
        vim.api.nvim_set_hl(0, 'RenderMarkdownCode', { bg = colors.base })
        vim.api.nvim_set_hl(0, 'RenderMarkdownCodeBorder', { fg = colors.surface2 })
